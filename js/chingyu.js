...
function appendfriendsformenu(){
    ...
    for(var i=0;i<friend_magnitude;i++){
        let friend="<div class='slideleft'><button class='deletebutton gone'>删除</button><div id='friend-num"+i+"'class='friend'><img id='friend-header'src='../resources/nav/create_chat.png'/><div class='friend-text'><h3 id='friend-name'>鄭青宇</h3></div></div><s class='space'></s><div>";
