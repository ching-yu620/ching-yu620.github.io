...
function appendfriendsformenu(){
    ...
    for(var i=0;i<friend_magnitude;i++){
        let friend="<div class='slideleft'><div id='friend-num"+i+"'class='friend'><img id='friend-header'src='../resources/nav/create_chat.png'/><div class='friend-text'><h3 id='friend-name'>鄭青宇</h3></div></div><div class='deletebutton'>删除</div><s class='space'></s></div>";
